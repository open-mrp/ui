        ...
        <div className="space-y-8">
                ...
                <div className="space-y-4">
                    <div>
                        <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">
                            Using TooltipProvider delayDuration prop (use TooltipPrimitive.Root
                            directly)
                        </p>
                        <div className="flex items-center gap-4">
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">Shadows</p>
                        <div className="flex items-center gap-4 flex-wrap">
                            <Tooltip>
                                <TooltipTrigger asChild>
                    ...
                    <div>
                        <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">Borders</p>
                        <div className="flex items-center gap-4 flex-wrap">
                            <Tooltip>
                                <TooltipTrigger asChild>
                ...
                <div className="flex items-center gap-4">
                    <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                            <p>
                                This is a longer tooltip that contains more information. It can wrap
                                to multiple lines and will adjust its width accordingly.
                            </p>
                        </TooltipContent>
                    </Tooltip>
                </div>
                    ...
                    <div>
                        ...
                        <TooltipProvider delayDuration={300} skipDelayDuration={200}>
                            <TooltipPrimitive.Root>
                                ...
                                <TooltipContent>
                                    <p>This tooltip has a 300ms delay but skips the first 200ms</p>
                                </TooltipContent>
                            </TooltipPrimitive.Root>
                        </TooltipProvider>
                    </div>
                    ...
                    <div>
                        ...
                        <TooltipProvider delayDuration={300} disableHoverableContent={false}>
                            <TooltipPrimitive.Root>
                                ...
                                <TooltipContent>
                                    <p>You can move your mouse to this tooltip and it stays open</p>
                                </TooltipContent>
                            </TooltipPrimitive.Root>
                        </TooltipProvider>
                    </div>
