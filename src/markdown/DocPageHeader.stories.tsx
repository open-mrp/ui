...
export const LongContent: Story = {
    args: {
        ...
        subtitle:
            'Learn how to customize every aspect of the application to match your specific requirements and workflow',
    },
};
...
export const MultipleHeaders: Story = {
    render: () => (
        <div className="space-y-8">
            <DocPageHeader title="Introduction" subtitle="Welcome to our documentation" />
            <DocPageHeader title="Quick Start" subtitle="Get up and running in minutes" />
            <DocPageHeader
