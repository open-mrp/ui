        ...
        children: (
            <>
                <DocTab label="Introduction">
                    <div className="space-y-4">
                        <p>
                            Welcome to our comprehensive guide. This section provides an overview of
                            the key concepts and features you'll need to understand.
                        </p>
                        <p>
                ...
                <DocTab label="Configuration">
                    <div className="space-y-4">
                        ...
                        <p>
                            Each setting is documented with examples and best practices to help you
    ...
    render: () => (
        <DocTabs>
            <DocTab label="Introduction">
                <div className="space-y-4">
                    <p>
                        Welcome to our comprehensive guide. This section provides an overview of the
                        key concepts and features you'll need to understand.
                    </p>
                    <p>
                        We'll cover everything from basic setup to advanced configuration options,
            ...
            <DocTab label="Configuration">
                <div className="space-y-4">
                    <p>
                        This section covers all configuration options available in the system. You
                        can customize various aspects of the application to match your specific
                        requirements.
                    </p>
                    <p>
                        Each setting is documented with examples and best practices to help you make
                        the most of the available options.
                    </p>
                </div>
            </DocTab>
        </DocTabs>
