...
describe('FluidRenderer', () => {
    ...
    describe('Constructor', () => {
        ...
        it('should create FluidRenderer with different color configurations', () => {
            ...
            colorConfigs.forEach((colorConfig) => {
                ...
                renderer = new FluidRenderer(canvas, {}, undefined, 6, undefined, colorConfig);
        ...
        it('should handle missing OES_texture_half_float extension in WebGL1', () => {
            ...
            expect(() => new FluidRenderer(canvas)).toThrow('OES_texture_half_float not supported');
        });
    });
    ...
    describe('WebGL Context Handling', () => {
        ...
        it('should handle unsupported texture formats', () => {
            mockGL.checkFramebufferStatus = jest.fn(() => mockGL.FRAMEBUFFER_INCOMPLETE_ATTACHMENT);
    ...
    describe('Render Loop', () => {
        ...
        it('should handle canvas resize during render', () => {
            ...
            const lastCall = mockGL.viewport.mock.calls[mockGL.viewport.mock.calls.length - 1];
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle program linking errors gracefully', () => {
            ...
            mockGL.getProgramParameter = jest.fn((program: WebGLProgram, param: number) => {
    ...
    describe('Program Class', () => {
        ...
        beforeEach(() => {
            ...
            program = {
                ...
                getUniforms: function () {
                    if (mockGL.getProgramParameter(this.program, mockGL.LINK_STATUS) === false) {
        ...
        it('should create program with uniforms', () => {
            mockGL.getProgramParameter.mockImplementation((prog: WebGLProgram, pname: number) => {
                if (pname === mockGL.LINK_STATUS) return true;
                if (pname === mockGL.ACTIVE_UNIFORMS) return 2;
                return null;
            });

            mockGL.getActiveUniform.mockImplementation((prog: WebGLProgram, idx: number) => ({
    ...
    describe('Shader Keywords and Display Material', () => {
        ...
        it('should update display material keywords', () => {
            ...
            expect((renderer as any).displayMaterial.setKeywords).toHaveBeenCalledWith(
