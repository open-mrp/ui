...
describe('DuffingShader', () => {
    const mockUseViewportWidth = require('@/hooks/useViewportWidth').useViewportWidth;
    ...
    describe('Configuration Updates', () => {
        ...
        test('updates color configuration when prop changes', async () => {
            ...
            const { rerender } = render(<DuffingShader colorConfiguration="default" />);
            ...
            await waitFor(() => {
                expect(mockRenderer.updateColorConfiguration).toHaveBeenCalledWith('fire');
            });
        });
    });
    ...
    describe('Edge Cases', () => {
        ...
        test('handles rapid prop changes', async () => {
            ...
            for (let i = 0; i < 5; i++) {
                rerender(<DuffingShader colorConfiguration={i % 2 === 0 ? 'fire' : 'default'} />);
            }
    ...
    describe('Advanced Edge Cases and Math Functions', () => {
        ...
        test('handles backgroundColor override in config merging', async () => {
            ...
            render(<DuffingShader backgroundColor={customColor} config={{ PRESSURE: 0.7 }} />);
        ...
        test('viewport width null to value transition', () => {
            ...
            let container = document.querySelector('.relative.w-full.h-full.overflow-hidden');
            expect(container).toHaveStyle({
                width: '500px',
                height: '275px',
            });
            ...
            container = document.querySelector('.relative.w-full.h-full.overflow-hidden');
            expect(container).toHaveStyle({
                width: '900px',
                height: '450px',
            });
