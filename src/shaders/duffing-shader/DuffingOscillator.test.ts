...
describe('DuffingOscillator Functionality Tests', () => {
    ...
    describe('update method', () => {
        ...
        test('should maintain energy conservation approximately', () => {
            ...
            const calculateEnergy = (result: { x: number; y: number; dx: number; dy: number }) => {
    ...
    describe('updateAndGetSplat method', () => {
        test('should return splat data and new texcoord', () => {
            ...
            const result = oscillator.updateAndGetSplat(0.016, canvas, color, prevTexcoord);
        ...
        test('should handle different aspect ratios', () => {
            ...
            expect(portraitResult.splatData.deltaX).not.toBe(landscapeResult.splatData.deltaX);
        });
        ...
        test('should handle square aspect ratio', () => {
            ...
            const result = oscillator.updateAndGetSplat(0.016, squareCanvas, color, prevTexcoord);
        ...
        test('should clamp coordinates to [0, 1] range', () => {
            ...
            for (let i = 0; i < 100; i++) {
                const result = oscillator.updateAndGetSplat(0.02, canvas, color, prevTexcoord);
    ...
    describe('Update Performance', () => {
        ...
        test('should scale performance with multiple oscillators', () => {
            ...
            for (let i = 0; i < oscillatorCount; i++) {
                oscillators.push(new DuffingOscillator({ index: i, total: oscillatorCount }));
            }
