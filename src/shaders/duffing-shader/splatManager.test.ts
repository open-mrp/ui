...
describe('SplatManager Integration', () => {
    ...
    test('should handle initSplatShaders with manual filtering', () => {
        ...
        const mockCompileShader = jest.fn((type: number, source: string, keywords?: string[]) => {
        ...
        const result = initSplatShaders(mockGL, baseVertexShader, mockCompileShader, false);
