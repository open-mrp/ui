...
import { blurShader, blurVertexShader, sunraysMaskShader, sunraysShader } from './shaders';
...
describe('SunraysManager Functionality Tests', () => {
    ...
    describe('initSunraysShaders', () => {
        test('should compile all required shaders', () => {
            ...
            tracker.reset();
            const result = initSunraysShaders(mockGL, baseVertexShaderObject, mockCompileShader);
            ...
            expect(mockCompileShader).toHaveBeenCalledWith(mockGL.FRAGMENT_SHADER, sunraysShader);
            expect(mockCompileShader).toHaveBeenCalledWith(mockGL.VERTEX_SHADER, blurVertexShader);
            expect(mockCompileShader).toHaveBeenCalledWith(mockGL.FRAGMENT_SHADER, blurShader);
        });
    ...
    describe('applySunrays', () => {
        ...
        test('should handle zero weight correctly', () => {
            ...
            expect(mockGL.uniform1f).toHaveBeenCalledWith(mockPrograms.sunrays.uniforms.weight, 0);
        });
    ...
    describe('applySunraysBlur', () => {
        test('should apply blur iterations correctly', () => {
            ...
            const iterations = 3;
            applySunraysBlur(mockGL, mockTarget, mockTemp, iterations, mockBlurProgram, mockBlit);
        ...
        test('should handle zero iterations', () => {
            ...
            applySunraysBlur(mockGL, mockTarget, mockTemp, 0, mockBlurProgram, mockBlit);
        ...
        test('should use correct texel sizes', () => {
            ...
            applySunraysBlur(mockGL, mockTarget, mockTemp, 1, mockBlurProgram, mockBlit);
...
describe('SunraysManager Performance Tests', () => {
    ...
    describe('Integration Performance', () => {
        test('should perform full sunrays pipeline efficiently', () => {
            // Setup
            const baseVertexShaderObject = { id: 'vertex' } as unknown as WebGLShader;
            const shaders = initSunraysShaders(mockGL, baseVertexShaderObject, mockCompileShader);
