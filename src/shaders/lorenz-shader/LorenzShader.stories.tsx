...
export const ArtisticPigments: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: "Classic artistic pigment colors using the 'dusk' color scheme with dusky madder violet, deep lyons blue, eosine pink, and hay's russet.",
            },
        },
    },
};
...
export const DistanceBasedColoring: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Distance-based coloring where particle colors interpolate between Rosolane purple and Helvetia blue based on their distance to the oscillation centers.',
            },
        },
    },
};
