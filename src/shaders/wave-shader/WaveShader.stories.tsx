...
const meta = {
    ...
    argTypes: {
        ...
        backgroundColor: {
            control: 'object',
            description:
                'Background color as RGB tuple [r, g, b] with values 0-255. Default: #060815',
        },
    },
...
// Custom background color examples
export const DarkPurpleBackground: Story = {
    args: {
        ...Default.args,
...
export const MidnightBlue: Story = {
    args: {
        ...Default.args,
        backgroundColor: [10, 15, 35],
    },
};
