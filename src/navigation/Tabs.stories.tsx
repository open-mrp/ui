        ...
        <Tabs defaultValue="dashboard" className="w-[400px]">
            ...
            <TabsContent value="analytics" className="mt-4">
                <div className="p-4 border rounded-md">
                    ...
                    <p className="text-muted-foreground">Deep dive into your data and trends.</p>
                </div>
            </TabsContent>
...
export const Vertical: Story = {
    render: () => (
        <Tabs defaultValue="profile" orientation="vertical" className="flex gap-4 w-[500px]">
        ...
        <Tabs defaultValue="tab1" className="w-[600px]">
            ...
            <TabsContent value="tab4" className="mt-4">
                <div className="p-4 border rounded-md">
                    ...
                    <p className="text-muted-foreground">This is the content for tab 4.</p>
                </div>
            </TabsContent>
            <TabsContent value="tab5" className="mt-4">
                <div className="p-4 border rounded-md">
                    <h3 className="text-lg font-semibold mb-2">Tab 5 Content</h3>
                    <p className="text-muted-foreground">This is the content for tab 5.</p>
                </div>
            </TabsContent>
            <TabsContent value="tab6" className="mt-4">
                <div className="p-4 border rounded-md">
                    <h3 className="text-lg font-semibold mb-2">Tab 6 Content</h3>
                    <p className="text-muted-foreground">This is the content for tab 6.</p>
                </div>
            </TabsContent>
        </Tabs>
    ),
        ...
        <Tabs defaultValue="active" className="w-[400px]">
            ...
            <TabsContent value="active" className="mt-4">
                <div className="p-4 border rounded-md">
                    ...
                    <p className="text-muted-foreground">This tab is active and functional.</p>
                </div>
            </TabsContent>
