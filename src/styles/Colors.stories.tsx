...
const ColorSwatch = ({ colorClass, name }: { colorClass: string; name: string }) => (
...
const ColorSection = ({ title, colors }: { title: string; colors: { [key: string]: string } }) => (
    <div className="mb-8">
        ...
        <div className="p-6 dark:bg-background">
            ...
            <div className="mt-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <ColorSwatch name="White" colorClass="bg-white border border-gray-200" />
