    ...
    render: () => {
        ...
        return (
            <div className="space-y-8">
                ...
                <div>
                    <h3 className="text-lg font-semibold mb-4">Large Dataset Pagination</h3>
                    <div className="flex items-center justify-between w-full">
                        <PaginationControls
                            currentPage={15}
                            totalPages={50}
                ...
                <div>
                    <h3 className="text-lg font-semibold mb-4">Basic Pagination Components</h3>
                    <Pagination>
                        <PaginationContent>
                            <PaginationItem>
                                <PaginationPrevious
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                        Apply consistent styling to all pagination buttons using className. This
                        example shows primary-colored borders.
                    </p>
                    <Pagination>
                        <PaginationContent>
                            <PaginationItem>
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                        Match the styling of input components like Select and ColumnToggleDropdown.
                    </p>
                    <Pagination>
                        <PaginationContent>
                            <PaginationItem>
    ...
    render: () => {
        ...
        return (
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-2xl font-bold">Custom Styled Paginated Table</h2>
                        <p className="text-gray-600 dark:text-gray-300">
